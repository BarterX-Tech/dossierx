...
func newClaimNewCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: "Author a new draft claim at <claims_dir>/<id>.yaml.\n\n" +
			"The claim it writes is shaped to pass the lint suite immediately: a body, and\n" +
			"layout: card (or --layout). Draft authoring is deliberately unfrictioned — no --reason,\n" +
