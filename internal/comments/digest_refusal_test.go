...
// realLeafCommands is the v0.3.0 CLI surface, as a set: six nouns, nineteen
...
// and it is restated in skills/dossierx/SKILL.md's "six nouns, nineteen leaves"
...
//
// Two words are captured because three of the six nouns are groups, and the
