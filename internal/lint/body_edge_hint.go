...
// real claim's id that isn't declared through this claim's actual
// rests_on edges. Prose that says "see widget.contract.overview" but never
// lists widget.contract.overview under rests_on is a strong hint the edge
// was meant to be declared and was simply forgotten. This is a WARNING, not an error: the
