...
// claim with neither says nothing about what it builds on, and a NONE without
// a reason says "nothing" without saying why. Both are error severity — the
// shape is the contract. NONE beside targets never reaches this lint: the
// rests_on decoder refuses that mapping at load (model.RestsOn.UnmarshalYAML).
