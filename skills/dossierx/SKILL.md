...
| `view_too_large` | 1 | `manifest show --isolation` (especially with `--bodies`) exceeded the hard isolation-view byte cap. Nothing was written. Drop `--bodies` or shorten claim text; isolation is summaries by default. |
