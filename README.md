...
|---|---|---|
| **Surface** | the CLI: 24 commands under 8 nouns, JSON by default | the viewer: `dossierx serve`, plus chat with the agent |
...
Twenty-four leaf commands under eight nouns. This is a *machine* surface: a human is not expected to run any of it. Use `dossierx <noun> --help` for flags, and `--format text` when you want prose.
