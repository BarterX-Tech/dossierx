...
1. If the `dossierx` binary is missing, install it with
   `go install github.com/BarterX-Tech/dossierx/cmd/dossierx@v0.7.15`,
...
4. ASK ME before installing the git pre-commit hook. My answer decides the
   ...
   https://raw.githubusercontent.com/BarterX-Tech/dossierx/v0.7.15/scripts/install-git-hook.sh
