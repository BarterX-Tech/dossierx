...
| `source_dirs` | []string | no | Directories (relative to the config file) scanned for `dossierx-claim: <id>` and `dossierx-step: <id> #<n> <sha256>` source comments — the code side of claim-to-code linking. Unset means "do not scan." |
