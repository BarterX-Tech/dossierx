...
- [ ] **The two committed sample viewers are regenerated.** This is the last
      ...
      artifacts (line 1: "generated by dossierx check … do not edit"), and no
      test reads either one — a rendering, CSS or viewer-chrome change ships
      without them going stale, which happened in both v0.3.1 and v0.4.1,
      caught by review each time, not by CI. Run:
      ...
      timestamp (line 1, and the sidebar-footer "Generated …" string) plus
