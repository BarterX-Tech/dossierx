...
The `docs-claim: <id>` source-scanning mechanism (the `source_dirs` config field, drift
detection via `docs flag` / `docs reaudit`, and the viewer's "implemented in" line) is covered
