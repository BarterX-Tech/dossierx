...
- Regenerated committed fixture viewers for the mobile-drawer Escape/search
  focus runtime (`searchFocusFrame`). Generation stamps are unchanged. Byte
  sizes move as follows: `fixture-basic` 1175554 -> 1176486;
  `fixture-conformance-v1` 1229699 -> 1230631; `fixture-graph-demo` 1438165 ->
  1439097; `fixture-portability` 1180057 -> 1180989; `fixture-theme-flat`
  4818961 -> 4819893.
...
- Keep all root-suite performance-only assertions race-aware. Unix race
  instrumentation no longer turns diagnostic timing ceilings into false
  failures, while production bounds and race-time correctness, allocation, and
  output-size checks remain enforced.
...
- Make the published root lint gate complete: private renderer convenience
  wrappers now report errors honestly, unreachable wrappers are removed, and
  the live conformance scale fixture names its returned values. Runtime output
  and viewer behavior are unchanged.
