...
byte-compared in CI, so this class of finding never reaches a reading agent again. A consumer sees
...
reason, and a re-read of every surface, because every stage-2 key hashes the manifest.
...
The last four the rounds recorded and did not close:
